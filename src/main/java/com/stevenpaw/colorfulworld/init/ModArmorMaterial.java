...
public enum ModArmorMaterial implements IArmorMaterial {
    TEST(ColorfulWorld.MOD_ID + ":test", 5, new int[]{7, 9, 11, 7}, 420, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 6.9F, () -> {
    ...
    private ModArmorMaterial(String nameIn, int maxDamageFactorIn, int[] damageReductionAmountArrayIn, int enchantabilityIn,
