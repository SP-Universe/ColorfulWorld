package com.stevenpaw.colorfulworld.client.gui;
...
public class ExampleChestScreen extends ContainerScreen<ExampleChestContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(ColorfulWorld.MOD_ID, "textures/gui/example_chest.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.font.drawString(this.title.getFormattedText(), 9.0f, 6.0f, 4210752);
