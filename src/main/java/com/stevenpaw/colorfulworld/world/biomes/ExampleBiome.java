package com.stevenpaw.colorfulworld.world.biomes;
...
public class ExampleBiome extends Biome {
    ...
    public ExampleBiome(Builder biomeBuilder) {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.NORMAL_TREE.withConfiguration(JazzTree.JAZZ_TREE_CONFIG).withPlacement(
